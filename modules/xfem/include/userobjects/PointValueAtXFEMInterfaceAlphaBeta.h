...
#ifndef POINTVALUEATXFEMINTERFACEALPHABETA_H
#define POINTVALUEATXFEMINTERFACEALPHABETA_H
...
template <>
InputParameters validParams<PointValueAtXFEMInterfaceAlphaBeta>();

class PointValueAtXFEMInterfaceAlphaBeta : public GeneralUserObject,
                                  public CoupleableMooseVariableDependencyIntermediateInterface,
                                  public MooseVariableInterface<Real>
{
public:
  PointValueAtXFEMInterfaceAlphaBeta(const InputParameters & parameters);

  virtual ~PointValueAtXFEMInterfaceAlphaBeta() {}
...
protected:
  ...
  const MovingLineSegmentCutSetUserObjectAlphaBeta * _geo_cut;
