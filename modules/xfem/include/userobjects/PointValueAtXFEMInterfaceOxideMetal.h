...
#ifndef POINTVALUEATXFEMINTERFACEOXIDEMETAL_H
#define POINTVALUEATXFEMINTERFACEOXIDEMETAL_H
...
class PointValueAtXFEMInterfaceOxideMetal;
class XFEM;
class MovingLineSegmentCutSetUserObjectOxideMetal;

template <>
InputParameters validParams<PointValueAtXFEMInterfaceOxideMetal>();

class PointValueAtXFEMInterfaceOxideMetal : public GeneralUserObject,
                                  public CoupleableMooseVariableDependencyIntermediateInterface,
                                  public MooseVariableInterface<Real>
{
public:
  PointValueAtXFEMInterfaceOxideMetal(const InputParameters & parameters);

  virtual ~PointValueAtXFEMInterfaceOxideMetal() {}
...
protected:
  /**
   * Find the leocal element in the element pairs that contains the point in its physical domain.
  ...
  const MovingLineSegmentCutSetUserObjectOxideMetal * _geo_cut;
