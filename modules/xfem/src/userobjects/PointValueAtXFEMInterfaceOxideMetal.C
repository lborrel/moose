...
registerMooseObject("XFEMApp", PointValueAtXFEMInterfaceOxideMetal);

template <>
InputParameters
validParams<PointValueAtXFEMInterfaceOxideMetal>()
{
...
PointValueAtXFEMInterfaceOxideMetal::PointValueAtXFEMInterfaceOxideMetal(const InputParameters & parameters)
    ...
    _solution(_system.current_local_solution.get())
{
  ...
  _geo_cut = dynamic_cast<const MovingLineSegmentCutSetUserObjectOxideMetal *>(uo);
  ...
  if (_xfem == nullptr)
    mooseError("Problem casting to XFEM in PointValueAtXFEMInterfaceOxideMetal");
...
void
PointValueAtXFEMInterfaceOxideMetal::initialize()
{
  _pl = _mesh.getPointLocator();
}

void
PointValueAtXFEMInterfaceOxideMetal::execute()
{
...
void
PointValueAtXFEMInterfaceOxideMetal::finalize()
{
...
const Elem *
PointValueAtXFEMInterfaceOxideMetal::getLocalElemContainingPoint(const Point & p, bool positive_level_set)
{
