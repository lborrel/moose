...
registerMooseObject("XFEMApp", PointValueAtXFEMInterfaceAlphaBeta);
...
PointValueAtXFEMInterfaceAlphaBeta::PointValueAtXFEMInterfaceAlphaBeta(const InputParameters & parameters)
    ...
    _solution(_system.current_local_solution.get())
{
  ...
  _geo_cut = dynamic_cast<const MovingLineSegmentCutSetUserObjectAlphaBeta *>(uo);
  ...
  if (_xfem == nullptr)
    mooseError("Problem casting to XFEM in PointValueAtXFEMInterfaceAlphaBeta");
...
void
PointValueAtXFEMInterfaceAlphaBeta::initialize()
{
  _pl = _mesh.getPointLocator();
}

void
PointValueAtXFEMInterfaceAlphaBeta::execute()
{
...
void
PointValueAtXFEMInterfaceAlphaBeta::finalize()
{
